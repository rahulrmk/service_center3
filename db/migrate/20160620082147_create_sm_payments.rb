class CreateSmPayments < ActiveRecord::Migration[7.0]
  def change
    create_table :sm_payments do |t|#, {:sequence_start_value => '1 cache 20 order increment by 1'}  do |t|
      ...
      t.integer  :transfer_amount, :comment => "the transfer amount"
