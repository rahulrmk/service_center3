class CreateSuUnapprovedRecords < ActiveRecord::Migration[7.0]
  def change
    create_table :su_unapproved_records do |t|#, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
