class CreateSmUnapprovedRecords < ActiveRecord::Migration[7.0]
  def up
    create_table :sm_unapproved_records do |t|#, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
